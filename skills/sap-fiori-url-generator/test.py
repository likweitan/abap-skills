...
from fiori_url_generator import FioriUrlGenerator
...
def test_basic_url_generation():
    ...
    assert result['url'] == expected_url, f"URL mismatch! Expected:\n{expected_url}\nGot:\n{result['url']}"
    print("\n✓ Test passed!")
    print()
...
def test_app_not_found():
    ...
    try:
        generator.generate_url(
            'https://myserver.com:44300',
            'Nonexistent App That Does Not Exist'
        )
