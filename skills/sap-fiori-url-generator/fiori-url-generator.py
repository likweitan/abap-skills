...
class FioriUrlGenerator:
    ...
    def generate_url(self, base_url: str, client: str, app_name: str,
        ...
        # Construct URL
        url = (f"{clean_base_url}/sap/bc/ui2/flp?"
...
def main():
    """CLI interface"""
    if len(sys.argv) < 3:
        print('Usage: python fiori-url-generator.py <base-url> <client> <app-name> [language]')
        print('Example: python fiori-url-generator.py '
    ...
    # Find AppList.json in current directory or parent
    ...
    try:
        if sys.argv[1] == 'search':
            ...
            result = generator.generate_url(base_url, client, app_name, language=language)
